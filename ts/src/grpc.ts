...
import {Chunk, ChunkParser, ChunkType} from "./ChunkParser";
import {DefaultTransportFactory, Transport, TransportOptions} from "./transports/Transport";
import {DebuggerDispatch} from "./debug";
...
export namespace grpc {
  ...
  export type UnaryMethodDefinition<TRequest extends jspb.Message, TResponse extends jspb.Message> =
  ...
  export function invoke<TRequest extends jspb.Message, TResponse extends jspb.Message, M extends MethodDefinition<TRequest, TResponse>>(methodDescriptor: M, props: RpcOptions<TRequest, TResponse>): Request {
    ...
    const request = {
      ...
      onChunk: (chunkBytes: Uint8Array) => {
        ...
        debuggers.onResponseChunk(data, chunkBytes);
